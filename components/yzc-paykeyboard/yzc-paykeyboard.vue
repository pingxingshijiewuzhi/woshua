	...
	<view>
		...
		<view :class="['content', show ? '' : 'contenthide']">
			<view class="title">
				...
				<view class="center">输入支付密码</view>
				<view class="close yuan" @click="close()">
					<image src="../../static/image/icon_mm_gb@2x.png" />
				</view>
			</view>
			<!-- <view class="title">
				<view class="close" @click="close()"><image src="../../static/image/icon_mm_gb@2x.png" /></view>
			...
			<view class="pay-way">
				<view>支付方式</view>
				<view class="pay-img"><image src="../../static/yue.png"/>{{moneytype}}</view>
			</view> -->
			...
			<view class='resetbox'>
				<view class='resetpassword' @click='resetpassword'>重置密码</view>
			</view>
			<view class="btns_new flexs">
				<image class="btns_img_new" src="../../static/image/btn_mz_qdzf@2x.png" @click="makesure()"></image>
			</view>
		</view>
		<!-- 键盘 -->

...
/***/ 1083:
/*!*****************************************************************!*\
  !*** D:/wangzichi/woshua/woBrush/components/uni-icons/icons.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 11:
/*!****************************************************!*\
  !*** D:/wangzichi/woshua/woBrush/common/common.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@vue/babel-preset-app/node_modules/@babel/runtime/regenerator */ 12));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}var _default = {
  ...
  // baseUrl: 'http://woshua.com',
  //imageUrl: 'http://192.168.1.7:8080',
  //imageUrl:'http://wanmeiapi.xzjumeng.com/images/',
  ...
  timestampToTime: function timestampToTime(timestamp) {
    ...
    var hours = dateObj.getHours() >= 10 ? dateObj.getHours() : '0' + dateObj.getHours(); // 获取时
    var minutes = dateObj.getMinutes() >= 10 ? dateObj.getMinutes() : '0' + dateObj.getMinutes(); // 获取分 
    var seconds = dateObj.getSeconds() >= 10 ? dateObj.getSeconds() : '0' + dateObj.getSeconds(); // 获取秒
    var haomiao = dateObj.getMilliseconds() >= 10 ? dateObj.getMilliseconds() : '0' + dateObj.getMilliseconds(); // 获取秒
  ...
  interval: function interval(faultDate, completeTime) {
  ...
  upimg: function upimg(count, isup, stypearr, sizeTypearr) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var that, urlList, imgList, i, len;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              that = _this;
              urlList = [];_context.next = 4;return (
                that.reqImg(count, stypearr, sizeTypearr));case 4:imgList = _context.sent;if (!(
              !isup || isup == 1)) {_context.next = 19;break;}
              i = 0, len = imgList.length;case 7:if (!(i < len)) {_context.next = 16;break;}_context.t0 =
              urlList;_context.next = 11;return that.addimg(imgList[i]);case 11:_context.t1 = _context.sent;_context.t0.push.call(_context.t0, _context.t1);case 13:i++;_context.next = 7;break;case 16:return _context.abrupt("return",

              urlList);case 19:if (!(
              isup == 2)) {_context.next = 21;break;}return _context.abrupt("return",
              imgList);case 21:case "end":return _context.stop();}}}, _callee);}))();

  },
  //打开相册
  reqImg: function reqImg(count, stypearr, sizeTypearr) {
    var that = this;
    return new Promise(function (resolve, reject) {
  ...
  //上传图片
  addimg: function addimg(imgfil) {var _this2 = this;
    return new Promise(function (resolve, reject) {
      var that = _this2;
      // console.log(imgfil)
...
/***/ 1117:
/*!********************************************************************************!*\
  !*** D:/wangzichi/woshua/woBrush/address/components/pick-regions/regions.json ***!
  \********************************************************************************/
...
/***/ 1123:
/*!******************************************************************************!*\
  !*** D:/wangzichi/woshua/woBrush/components/jyf-parser/libs/MpHtmlParser.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
 ...
 * @listens MIT
 */
var cfg = __webpack_require__(/*! ./config.js */ 1124),
blankChar = cfg.blankChar,
CssHandler = __webpack_require__(/*! ./CssHandler.js */ 1125),
...
/***/ 1124:
/*!************************************************************************!*\
  !*** D:/wangzichi/woshua/woBrush/components/jyf-parser/libs/config.js ***!
  \************************************************************************/
/*! no static exports found */
...
/***/ 1125:
/*!****************************************************************************!*\
  !*** D:/wangzichi/woshua/woBrush/components/jyf-parser/libs/CssHandler.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!**********************************************!*\
  !*** D:/wangzichi/woshua/woBrush/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {

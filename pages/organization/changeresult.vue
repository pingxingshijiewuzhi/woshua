<template>
	<view class='changeresult'>
		...
		<view class='changeresult_header'>
			<view class='imgbox'>
				<image src="../../static/pic/icon_d_ddhs@2x.png" mode=""></image>
			</view>
			<view class='opacitytitle'>等待回收</view>
		</view>
		<!-- 		<view class='changeresult_header'>
			<view class='imgbox'>
				<image src="../../static/pic/icon_d_cg@2x.png" mode=""></image>
			</view>
			<view class='opacitytitleooo'>确认回收</view>
		</view> -->
		<!-- <view class='changeresult_header'>
			<view class='imgbox'>
		...
		<view class='changeresult_content'>

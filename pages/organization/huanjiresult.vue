<template>
	<view class='huanjiresult'>
		...
		<view class='huanjiresult_header'>
			<view class='imgbox'>
				<image src="../../static/pic/icon_d_ddhs@2x.png" mode=""></image>
			</view>
			<view class='opacitytitle'>审核中</view>
		</view>
		<!-- 		<view class='huanjiresult_header'>
			<view class='imgbox'>
				<image src="../../static/pic/icon_d_cg@2x.png" mode=""></image>
			</view>
			<view class='opacitytitleooo'>确定接收</view>
		</view> -->
		<!-- <view class='huanjiresult_header'>
			<view class='imgbox'>
				<image src="../../static/pic/icon_d_jj@2x.png" mode=""></image>
			</view>
			<view class='opacitytitleooo'>拒绝回收</view>
		</view> -->
		<view class='huanjiresult_content'>
			<view class='contetn_item'>
				<view class='item_left'>机具台数</view>
				<view class='item_right'>15</view>
			</view>
		</view>
		<view class='huanjiresult_content'>
			<view class='contetn_item'>
				<view class='item_left'>新机编号</view>
				<view class='item_right'>15555554464</view>
			</view>
		</view>
		<view class='huanjiresult_content'>
			<view class='contetn_item'>
		...
		<view class='huanjiresult_content'>
			<view class='contetn_item'>
				...
				<view class='item_right'>2018-12-22 13:13:14</view>
			</view>
		</view>
		<!-- <view class='huanjiresult_content'>
			<view class='contetn_item'>
				<view class='item_left'>通过时间</view>
				<view class='item_right'>2018-12-22  13:13:14</view>
			</view>
		</view> -->
		<view class='huanjiresult_content'>
			<view class='contetn_item'>
				<view class='item_left'>原因</view>
				<view class='item_right'>人为损坏</view>
			</view>
		</view>

		<!-- 等待回收显示按钮 -->
		<!-- <view class='bottombtn'>
			<view class='sayno'>拒绝</view>
			<view class='sayture'>确认回收</view>
		</view> -->
	</view>
</template>
